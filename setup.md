...
- `.gitignore`
  - at the very least, have `bin` in here...you can put `.project` in here if you want other instructors to use import to work with the code in Eclipse
- `.pmd`
  - same kind of deal as in the `.checkstyle` entry above
- `.project` **not shared with students**
